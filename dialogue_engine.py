...
# speak("नमस्ते, आप क्या करना चाहते हैं")
...
# else:
#     speak("कृपया दोबारा बोलिए")   # look for problem
...
# speak("आपकी पर्ची तैयार है धन्यवाद")

# print("Final Data:", name, account, amount, phone)
