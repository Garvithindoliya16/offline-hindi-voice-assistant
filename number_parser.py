word_to_num = {
    ...
    "नब्बे":90,"इक्यानवे":91,"बानवे":92,"तिरानवे":93,"चौरानवे":94,"पचानवे":95,"छियानवे":96,"सत्तानवे":97,"अट्ठानवे":98,"निन्यानवे":99,
    "सौ":100,"हजार":1000
}

start_words = {"एक","दो","तीन","चार","पाँच","छह","सात","आठ","नौ","दस"}

def extract_number(text):
    words = text.replace("है","").replace("हैं","").split()
    results=[]
    total=0
    current=0
    started=False
    ...
    for w in words:
        if w in start_words and started and (total+current)>0:
